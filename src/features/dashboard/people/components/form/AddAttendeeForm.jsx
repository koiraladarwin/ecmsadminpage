...
function AddAttendeeForm() {
  ...
  const [attendeeType, setAttendeeType] = useState('company')
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-end">
          <label className="flex items-center gap-2">
            <input
              ...
              name="attendeeType"
              value="individual"
              checked={attendeeType === 'individual'}
              onChange={() => setAttendeeType('individual')}
            />
            Individual
          </label>
          <label className="flex items-center gap-2">
            <input
              ...
              name="attendeeType"
              value="company"
              checked={attendeeType === 'company'}
              onChange={() => setAttendeeType('company')}
            />
