...
})
{
    ...
    return(
        <>
            <div className="flex justify-between box-border p-2 m-2 border-none rounded-lg shadow-xl  ">
                ...
                <div className="border rounded-2xl p-2 pl-10 pr-10 bg-borderbox-bg border-none">
                    <h1>Invitation</h1>
