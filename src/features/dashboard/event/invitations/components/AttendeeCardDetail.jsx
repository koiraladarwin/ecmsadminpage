        ...
        <div>
            <div className="border border-textgray rounded-2xl shadow-2xl ">
                <div className="flex gap-8 m-2 p-2">
                    <div >
                        <img src={'/placeholder.jpg'} alt="" className="w-14 h-14 border-2 rounded-full border-buttonpurple" />

                    </div>
                    <div className="flex flex-col items-start">
                        <h1>{full_name}</h1>
                        <p className="text-sm text-textgray">{position}</p>
                        <p className="text-sm text-textgray">{company}</p>
                        <p className="text-xs text-textgray">{gmail}</p>
                        <p className="text-xs text-textgray">{phone_number}</p>
                    </div>
                </div>
